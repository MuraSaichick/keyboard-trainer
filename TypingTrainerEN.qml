...
Item {
    ...
    ScrollView {
        ...
        GridLayout {
            ...
            Repeater {
                model: lessonManager.getLessonsCount("en")
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        Text {
                            anchors.centerIn: parent
                            text: lessonManager.getLessonType("en", index + 1)
                            font.bold: true
                            font.pixelSize: 14
                            color: themeManager.text
                        }
                        ...
                        Rectangle {
                            ...
                            Rectangle {
                                ...
                                Row {
                                    ...
                                    Text {
                                        text: lessonManager.getUserLessonSpeed(UserStats.getUserId(), index + 1, "en")
                                        font.pixelSize: 14
                                        color: themeManager.text
                                        anchors.verticalCenter: parent.verticalCenter
                                    }
                            ...
                            Rectangle {
                                ...
                                Row {
                                    ...
                                    Text {
                                        text: lessonManager.getUserLessonAccuracy(UserStats.getUserId(), index + 1, "en")
                                        font.pixelSize: 14
                                        color: themeManager.text
                                        anchors.verticalCenter: parent.verticalCenter
                                    }
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            ...
                            rootItem.printLessonRequested(index + 1, lessonManager.getLessonText(index + 1, "en"), "en");
                        }
                    }
                }
            }
